    ...
    <div class="row col">
        <form action="create.php" method="post" enctype="multipart/form-data">
            ...
            <div class="col center">
                ...
                <input value="<?= $description ?>" name="description" class="form-control" id="content"
                       placeholder="Введите описание проекта" rows="6">
            </div>
            <div class="w-100"></div>
            ...
            <div class="button post-name center1 ">
                <button name="create-post" class="btn btn-primary" type="submit">создать / применить</button>
            </div>
            <div class="button post-name center1 ">
